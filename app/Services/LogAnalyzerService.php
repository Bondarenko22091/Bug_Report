...
class LogAnalyzerService
{
    public function analyze(string $text, array $imagePaths = [], array $documentPaths = []): GeneratedReport
    {
        ...
        $prompt = "Ты — система автоматического создания баг-репортов. Твоя задача — проанализировать логи и приложенные файлы.\n\n"
            . "ИСХОДНЫЙ ТЕКСТ ЛОГА:\n" . $text . "\n"
            . $pdfText . "\n"
            . "СТРОГИЕ ПРАВИЛА:\n"
            . "1. Если в блоке [ДАННЫЕ ИЗ PDF ФАЙЛА] есть информация, ты ОБЯЗАН использовать её в анализе.\n"
            . "2. Если есть скриншоты, проанализируй их визуально и включи наблюдения в actual_result.\n"
            . "3. НЕ придумывай данные, которых нет в логах или файлах.\n"
            . "4. Если данных недостаточно, напиши: 'Недостаточно информации для полного анализа'.\n"
            . "5. severity выбирай СТРОГО из: low, medium, high, critical.\n"
            . "6. steps_to_reproduce должны быть конкретными и основанными на данных из лога.\n"
            . "7. Отвечай ТОЛЬКО на русском языке в формате JSON согласно схеме.";
